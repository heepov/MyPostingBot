...
ERROR_ADD_POST_NEED_PHOTO = "Please send an image for the post."
ERROR_DATE_TIME_PAST = "The date and time must be in the future."
ERROR_NEED_CANCEL = "This command works only after using the /cancel command."
...
COMMAND_SETUP = "To connect a channel, send me the CHANNEL link or username."
...
ADD_POST_MEDIA_FILES = "Now upload the file to be included as a comment. Once uploaded, send the /time command."
...
CHANNEL_SETUP_STRING = "Now please send the CHAT link or username:"
